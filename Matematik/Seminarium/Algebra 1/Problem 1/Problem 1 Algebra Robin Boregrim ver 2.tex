...
Isolerar sedan den kvarvarande rottermen  $ - 4\sqrt{x+5}\sqrt{x-3}$
$$- 4\sqrt{x+5}\sqrt{x-3}= 25 - 5x - 17. $$
Där efter förenklar vi högerledet
...
För att validera $x_1$ sätter vi $x=4$ i vänsterledet och får
  ...
  $$2\sqrt{\frac{76}{9}+5}-\sqrt{8 + \frac{4}{9}-3} = 5$$
  $$2\sqrt{13.444\dots}-\sqrt{5.444\dots} = 5$$
  $$2 \cdot 3.666\dots - 2.333\dots = 5$$
